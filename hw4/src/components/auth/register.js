        ...
        <div className='col-md-4' id="registerDiv">
            ...
            <form onSubmit={(e) => {
                ...
                <div className="form-group">
                    ...
                    <input type="text" placeholder="qisuozhi" ref={(node) => accountname = node}
                    pattern="[a-zA-Z][a-zA-Z0-9]{1,20}" required />
                </div>
                <div className="form-group">
                    <label>Display Name</label><br />
                    <input type="text" placeholder="James" ref={(node) => dispname = node} />
                </div>
                <div className="form-group">
                    <label>Email Address</label><br />
                    <input type="email" placeholder="qisuozhi@gmail.com"
                    ref={(node) => email = node} pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required />
                </div>
                <div className="form-group">
                    <label>Phone Number</label><br />
                    <input type="tel" placeholder="812-606-4659" ref={(node) => phone = node}
                    pattern="\d{3}[\-]\d{3}[\-]\d{4}" required />
                </div>
                <div className="form-group">
                    <label>Date of Birth</label><br />
                    <input type="date" ref={(node) => birth = node} required />
                </div>
                <div className="form-group">
                    <label>Zipcode</label><br />
                    <input type="zipcode" placeholder="77005" ref={(node) => zipcode = node}
                ...
                <div className="landingAlert">{registerInfo}</div>
                <div>
